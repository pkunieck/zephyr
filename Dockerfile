FROM dockerhubcache.caas.intel.com/zephyrprojectrtos/ci-base:v0.26.0 as ci-lite
...
###################
FROM dockerhubcache.caas.intel.com/zephyrprojectrtos/ci:v0.26.0 as ci-sdk
ARG HTTPPROXY=
ARG HTTPSPROXY=
ARG NOPROXY=
ARG ARTIFACTORY_API_KEY=
